using Assets._Pinball.Scripts.Models.ProgressBar;
using Unity.Collections;
using UnityEngine.UIElements;
using UnityEngine;

namespace Assets._Pinball.Scripts.VisualElements
{
    public class RadialProgress : VisualElement
    {
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            UxmlFloatAttributeDescription progressAttribute = new UxmlFloatAttributeDescription()
            { name = "progress", defaultValue = 30 };

            UxmlFloatAttributeDescription widthAttribute = new UxmlFloatAttributeDescription()
            { name = "width", defaultValue = 25 };

            UxmlColorAttributeDescription backgroundColorAttribute = new UxmlColorAttributeDescription
            { name = "background-color", defaultValue = Color.grey };

            UxmlColorAttributeDescription fillColorAttribute = new UxmlColorAttributeDescription
